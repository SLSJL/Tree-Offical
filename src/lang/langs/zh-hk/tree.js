...
export default {
  ...
  details: {
    ...
    p2: {
      ...
      body2: `樹木就像充滿活力的體系，牢牢抓緊土壤，讓樹根、樹幹和樹葉得以固定。透過測量樹木的轉動方位或紀錄樹木的傾斜角度，我們可以檢測樹木潛在的根部狀況而有機會引致整棵樹木倒塌。配合風的外在力與樹木獨特的頻率振動，樹木的不同位置會形成相互作用。
      當風吹向樹冠時，樹基會產生轉向動力。同時，受根部的反作用力抵抗，形成力量的抗衡，利用根部的旋轉及移動角度，轉化成為量度抵抗力量的函數。如果根部不足以抵受轉向動量，樹木會開始傾斜或被連根拔起，然後倒下。因此，為了確保公眾安全，測量和監察城市樹木根部能夠準確地預測樹木倒塌風險，對樹木的穩定性非常重要。
      `
    },
    p3: {
      caption: "技術如何幫助樹木管理",
  ...
  acknowledgement:"特別鳴謝香港特區政府發展局，綠化、園境及樹木管理組提供本網站相關資訊咭的內容。",
  knowledgeInfo: {
