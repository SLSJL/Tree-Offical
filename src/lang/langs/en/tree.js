...
export default {
  ...
  details: {
    ...
    p4: {
      ...
      body1:
        "Trees of 9 vulnerable species at risk of tree falling with different tree forms are selected for monitoring, e.g. Bauhinia variegata, Delonix regia, Senna siamea.",
      body2: {
    ...
    p6: {
      ...
      body4:
        "https://www.greening.gov.hk/treeregister/map/treeIndex.aspx?lang=en-US"
    }
  },
  infocard: {
    tips:
      "Click at the cards below! You could discover how trees to be managed in Hong Kong!"
  },
  infoCards: [
    {
      id: "k-1-proper",
