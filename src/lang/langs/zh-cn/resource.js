export default {
  ...
  audio: {
    ...
    list: [
      {
        title: "智能传感技术　监察树木稳定性",
        address: "https://sc.devb.gov.hk/TuniS/www.devb.gov.hk/tc/home/my_blog/index_id_342.html",
        date: "16-June-2019",
      },
      {
  ...
  event: {
    caption: "活动",
    evt1: {
      title: "赛马会智能城市树木管理计划启动典礼",
      body:
        "赛马会智能城市树木管理计划启动典礼 – 2018年6月14日 香港理工大学（理大）今天（6月14日）正式启动一个由学术界、非牟利组织及政府合作的大型先导项目 — 赛马会智能城市树木管理计划，运用智能传感技术及地理信息系统，大规模监测树木的稳定性，以适时安排恰当的护养措施，从而延长树龄。<br /> <br />主礼嘉宾包括理大行政副校长卢丽华博士，香港特别行政区发展局常任秘书长韩志强工程师，香港赛马会慈善事务部主管（长者，康复，医疗，环保及家庭）陈戴英女士和理大建筑与环境学院院长徐幼麟教授。",
      link: "https://www.polyu.edu.hk/web/sc/media/media_releases/index_id_6551.html",
      detail: "详情",
    },
  },
  publication: {
