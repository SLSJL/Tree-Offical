export default [
  {
    title: `在樹木與毗鄰建築物/構築物之間預留足夠的生長空間`,
    content: `<p class="kc-text"> 樹木會隨着歲月生長，於太接近建築物/構築物的地方種植樹木，長遠而言樹木會因此變得外形不均稱及欠佳。</p>
    <p class="kc-text">	所以，在種植樹木時，應留有足夠的生長空間，並讓樹木跟毗鄰構築物保持適合的距離。避免在太接近建築物/構築物的地方種植樹木。在設計和實施階段應考慮樹木成熟時的高度和蔓延範圍，以確保從長遠來看，樹木的生長不會與相鄰的建築物/構築物互相阻檔。在有需要時，應適當的提升樹冠，以便為車輛交通留出足夠的淨空高度。</p>
    <p class="kc-img">	<img src=${require("./../../assets/images/tree/knowloge/proper/proper1.png")}></p>`
  },
  {
    title: `樹木保護範圍的設計(妥善保護工地的樹木)( (1)`,
    content: `<p class="kc-text">工程管理、設計和施工的各層人員對樹木保護都應有認識和理解，並且身體力行，盡力保護樹木。</p>
    <p class="kc-text">	團隊合作至關重要。</p>
    <p class="kc-text">	在初始規劃和設計階段，規劃和劃分適當的樹木保護範圍是必不可少的，它們不是事後的想法。</p>
  ...
  },
  {
    ...
    content: `<p class="kc-text">健康和結構的良的樹種具有以下特徵：</p>
          <p class="kc-sub-text">-	沒有扭結根、纏繞根或盤根等根部問題</p>
          <p class="kc-sub-text">-	沒有大面積的樹洞/傷痕/裂縫/裂痕</p>
          <p class="kc-sub-text">-	沒有病害/蟲害</p>
          <p class="kc-sub-text">-	沒有結構問題</p>`
  },
  {
    title: `提供足夠空間讓樹冠生長 (1)`,
  ...
  {
    title: `提供足夠空間讓樹冠生長  (2)`,
    content: `<p class="kc-text">在為樹木分配空間時，應考慮樹木的成熟形態、高度和樹冠的伸延以及種植目的。</p>
  ...
  {
    title: `樹基須留有足夠空間，不應栽種植物 (1)`,
    content: `<p class="kc-text">在設計、栽種和護養植被時，應盡量避免在樹幹基部周圍栽種植物或鋪上過多泥土 / 護根覆蓋 (即高過根領)，以免影響樹木生長及妨礙樹木檢查工作。</p>
    <p class="kc-img">	<img src=${require("./../../assets/images/tree/knowloge/proper/proper11.png")}></p>`
  },
  {
    title: `樹基須留有足夠空間，不應栽種植物 (2)`,
    content: `<p class="kc-text">在樹幹底部周圍的區域植被或土壤/護根覆蓋過多可能會導致：</p> 
  ...
  {
    title: `樹基須留有足夠空間，不應栽種植物 (3)`,
    content: `<p class="kc-text">在樹幹底部周圍的區域植被或土壤/護根覆蓋過多可能會導致：</p>
    <p class="kc-sub-text">	-	妨礙樹木檢查工作</p>
    <p class="kc-sub-text"> -	樹下種滿植物或蓋土/護根覆蓋過多會遮蔽樹基，使樹幹底部的問題在樹木檢查期間都不易被察覺。</p>
    `
  },
  {
