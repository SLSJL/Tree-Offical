export default [
  {
    title: `目的`,
    content: `<p class="kc-text">修剪树木是指清除树上多余的枝干，以改善树木结构、健康及形态。不适当的修剪树木除了妨碍树木健康成长和破坏树木的外观外，更可能对树木造成不可复原的损害。</p>
              <p class="kc-text"减少造成危险和对公众造成不便</p>
              <p class="kc-sub-text">- 减少造成危险和对公众造成不便</p>
              <p class="kc-sub-text">- 改善或维持树木健康和结构</p>
              <p class="kc-sub-text">- 改善树木外观</p>`
  },
  {
    title: `不正確的修剪技術`,
    content: `<p class="kc-text">在修剪树木时应注意以下事项:<p>
    <p class="kc-sub-text">- 切勿留下過大的剪切口 </p>
    <p class="kc-sub-text">- 切勿留下枝柄</p>
  ...
  {
    title: `修剪树木的类别 (2)`,
    content: `<p class="kc-sub-title">修减树冠</p>
