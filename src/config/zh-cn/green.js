...
export default [
  {
    title: `绿化的好处  (1)`,
    content: `<p class="kc-text">通过丰富美观的树木、灌木、花卉以及一系列合理分布和精心配置的城市绿化建设，不但能营造清新美丽、舒适优雅的环境，还可以改善城市生活条件，提高生活质量。</p>
  ...
  {
    title: `绿化的好处 (2)`,
    content: `<p class="kc-text">园林绿化是改变城市环境的重要途径。 通过种植树木，形成一个完整的绿化系统，可以实现空气净化、防止污染、调节气候、改善土壤质量和生态，以及美化环境。</p>
