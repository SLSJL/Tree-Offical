export default [
  ...
  {
    title: `Design for Tree Protection Zone (Effective tree protection on site) (2)`,
  ...
  {
    title: `Design for Tree Protection Zone (Effective tree protection on site) (3)`,
  ...
  },
  {
    ...
    content: `<p class="kc-text">Be mindful to plant trees too deep to make the root flare be invisible or too shallow to make the root system not firm.   Planting a tree too deep creates a lack of oxygen for the root system and causes tree declining over time, girdling roots and decay at the lower trunk or root flare</p>`
  },
  {
  ...
  },
  {
    ...
    <p class="kc-text">Allow flexibility in some overlapping of tree canopies for situational extension.</p>
            `
  },
  {
